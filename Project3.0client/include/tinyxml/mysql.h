...
public:
	...
	参数：
	   ...
	   charset:字符集
	*/
	int Connect(const char *database="mysql",const char *host="localhost",const char *port=NULL,const char *user="root",const char *passwd="131452",const char  *charset="utf8");
	/*
	功能：
		查询数据
	参数：
